...
class FileIO(csv.DictReader):
    ...
    def __next__(self):
        ...
        self._position += 1
        try:
            self._currentInput = super(FileIO, self).__next__()
            self._currentOutput = self._currentInput
            return self._currentInput
        except StopIteration: return False
        #print(self._currentInput)
    ...
    def getOutput(self,position=False):
        """
        Return output to be written at row position (defaults to first record).
        """
    ...
    def setOutput(self):
        ...
        #print('Pos: ',self._position,'Txt:',self._currentOutput)
